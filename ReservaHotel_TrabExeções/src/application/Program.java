...
public class Program {
	...
	public static void main(String[] args){ //meu metodo mains pode lançar um exce~]ao do tipo parseException
		...
		try {	//tentar
			...
			System.out.println("Error in reservation: " + e.getMessage());	//manter esse catch para meu programa nao quebrar
		}
		catch (RuntimeException e) {
			System.out.println("Unexpected error ");		//erro inesperado
		}
		sc.close();
	}
