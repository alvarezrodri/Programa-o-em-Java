...
public class GlobalParaLocal {
	...
	public static void main(String[] args) {
		...
		LocalDate r1 = LocalDate.ofInstant(d06, ZoneId.systemDefault());	//horario de sao paulo
		...
		System.out.println("d04 dia = " + d04.getDayOfMonth());	//Para procura especifica separadamente
		...
		//COMO CONVERTER DATA GLOBAL PARA DATA LOCAL
